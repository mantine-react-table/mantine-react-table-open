...
<Head>
  <title>{'MRT Hooks - Mantine React Table Open Docs'}</title>
...
[Source Code](https://github.com/KevinVandy/mantine-react-table-open/blob/v2/packages/mantine-react-table-open/src/hooks/useMantineReactTable.ts)
...
[Source Code](https://github.com/KevinVandy/mantine-react-table-open/blob/v2/packages/mantine-react-table-open/src/hooks/useMRT_TableOptions.ts)
...
```tsx
import { useMRT_TableOptions } from 'mantine-react-table-open';
...
[Source Code](https://github.com/KevinVandy/mantine-react-table-open/blob/v2/packages/mantine-react-table-open/src/hooks/useMRT_TableInstance.ts)
...
```tsx
import { useMRT_TableInstance } from 'mantine-react-table-open';
...
[Source Code](https://github.com/KevinVandy/mantine-react-table-open/blob/v2/packages/mantine-react-table-open/src/hooks/useMRT_Effects.ts)
...
[Source Code](https://github.com/KevinVandy/mantine-react-table-open/blob/v2/packages/mantine-react-table-open/src/hooks/useMRT_Rows.ts)
...
```tsx
import { useMantineReactTable, useMRT_Rows } from 'mantine-react-table-open';
...
[Source Code](https://github.com/KevinVandy/mantine-react-table-open/blob/v2/packages/mantine-react-table-open/src/hooks/useMRT_ColumnVirtualizer.ts)
...
[Source Code](https://github.com/KevinVandy/mantine-react-table-open/blob/v2/packages/mantine-react-table-open/src/hooks/useMRT_RowVirtualizer.ts)
