...
<Head>
  <title>{'MRT Components - Mantine React Table Open Docs'}</title>
  <meta
    name="description"
...
In previous versions of `mantine-react-table-open`, you only had the option to use the `<MantineReactTable />` component. Now in version 2, all internal MRT components are exported for you to to optionally use to build up your own custom table components.

### \<MantineReactTable /\>

[View Source Code on GitHub](https://github.com/KevinVandy/mantine-react-table-open/blob/v2/packages/mantine-react-table-open/src/components/MantineReactTable.tsx)
...
[View Table Components Source Code on GitHub](https://github.com/KevinVandy/mantine-react-table-open/tree/v2/packages/mantine-react-table-open/src/components/table)
...
[View TableHead Components Source Code on GitHub](https://github.com/KevinVandy/mantine-react-table-open/tree/v2/packages/mantine-react-table-open/src/components/head)
...
[View TableBody Components Source Code on GitHub](https://github.com/KevinVandy/mantine-react-table-open/tree/v2/packages/mantine-react-table-open/src/components/body)
...
[View TableFooter Components Source Code on GitHub](https://github.com/KevinVandy/mantine-react-table-open/tree/v2/packages/mantine-react-table-open/src/components/footer)
...
[View Input Components Source Code on GitHub](https://github.com/KevinVandy/mantine-react-table-open/tree/v2/packages/mantine-react-table-open/src/components/inputs)
