...
<Head>
  <title>Sticky Header/Footer Feature Guide - Mantine React Table Open Docs</title>
  <meta
    name="description"
...
View Extra Storybook **[Examples](https://www.mantine-react-table-open.dev/?path=/story/styling-sticky-header-examples)**
