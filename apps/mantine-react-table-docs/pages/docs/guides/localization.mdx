...
<Head>
  <title>{'Localization/i18n Guide - Mantine React Table Open Docs'}</title>
  <meta
    name="description"
...
The following locales are included and can be imported from `'mantine-react-table-open/locales/'`:
...
> If your language is not yet supported, please consider making a PR to add it to the library! See [here on GitHub](https://github.com/KevinVandy/mantine-react-table-open/tree/v2/packages/mantine-react-table-open/src/locales).
...
> Note: In some frameworks like Remix, you may need to use a full import path like <br /> `import { MRT_Localization_ES } from 'mantine-react-table-open/locales/es/index.js';` or <br /> `import { MRT_Localization_ES } from 'mantine-react-table-open/locales/es/index.esm.js';` <br />
...
For a full list of all available translation keys, see [here](https://github.com/KevinVandy/mantine-react-table-open/blob/v2/packages/mantine-react-table-open/src/locales/en.ts)
