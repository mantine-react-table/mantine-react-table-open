...
<Head>
  <title>{'Column Resizing Guide - Mantine React Table Open Docs'}</title>
  <meta
    name="description"
...
> MRT V8 has a new "opposite" behavior in regards to column sizes when column resizing is enabled compared to MRT V8
...
View Extra Storybook **[Examples](https://www.mantine-react-table-open.dev/?path=/story/features-column-resizing-examples)**
