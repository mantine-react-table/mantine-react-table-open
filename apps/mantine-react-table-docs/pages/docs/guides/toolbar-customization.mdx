...
<Head>
  <title>Toolbar Customization Guide - Mantine React Table Open Docs</title>
  <meta
    name="description"
...
The `renderToolbarInternalActions` table option allows you to redefine the built-in buttons that usually reside in the top right of the top toolbar. You can reorder the icon buttons or even insert your own custom buttons. All of the built-in buttons are available to be imported from 'mantine-react-table-open'.
